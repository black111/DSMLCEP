 ...
 * @generated
 */
public class TargetTargetOperationTypesCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7005SemanticChildren((View) getHost()
						.getModel());
