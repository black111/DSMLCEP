...
import dsml.diagram.edit.parts.EventOutputEventOutputQueriesCompartmentEditPart;
 ...
 * @generated
 */
public class EventOutputItemSemanticEditPolicy extends
		DsmlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EventOutputItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DsmlVisualIDRegistry.getVisualID(outgoingLink) == LinkTargetEditPart.VISUAL_ID) {
