 ...
 * @generated
 */
public class ConditionGroupConditionGroupOperationTypesCompartment4CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getConditionGroup_OperationTypes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7013SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7013SemanticChildren((View) getHost()
						.getModel());
