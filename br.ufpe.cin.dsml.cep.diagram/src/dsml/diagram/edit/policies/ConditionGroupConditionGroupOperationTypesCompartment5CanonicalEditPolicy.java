 ...
 * @generated
 */
public class ConditionGroupConditionGroupOperationTypesCompartment5CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7019SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7019SemanticChildren((View) getHost()
						.getModel());
