 ...
 * @generated
 */
public class TargetTargetOperationTypesCompartment7CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7026SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7026SemanticChildren((View) getHost()
						.getModel());
