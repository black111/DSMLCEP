 ...
 * @generated
 */
public class EventPatternEventPatternNodeCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getEventPattern_Node();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getEventPatternEventPatternNodeCompartment_7023SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getEventPatternEventPatternNodeCompartment_7023SemanticChildren((View) getHost()
						.getModel());
