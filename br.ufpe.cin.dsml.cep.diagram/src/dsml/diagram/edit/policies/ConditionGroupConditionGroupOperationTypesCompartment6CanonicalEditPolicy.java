 ...
 * @generated
 */
public class ConditionGroupConditionGroupOperationTypesCompartment6CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7027SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7027SemanticChildren((View) getHost()
						.getModel());
