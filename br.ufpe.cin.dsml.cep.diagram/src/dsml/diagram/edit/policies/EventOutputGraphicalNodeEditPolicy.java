...
import dsml.diagram.edit.commands.DsmlReorientConnectionViewCommand;
import dsml.diagram.providers.DsmlElementTypes;

/**
 * @generated
 */
public class EventOutputGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionCompleteCommand(
		...
		if (DsmlElementTypes.LinkTarget_4004 == elementType) {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		DsmlReorientConnectionViewCommand rcvCommand = new DsmlReorientConnectionViewCommand(
				editingDomain, null);
