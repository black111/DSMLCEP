 ...
 * @generated
 */
public class BringGroupBringGroupOperationTypesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7008SemanticChildren((View) getHost()
						.getModel());
