 ...
 * @generated
 */
public class BringGroupBringGroupOperationTypesCompartment6CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7029SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7029SemanticChildren((View) getHost()
						.getModel());
