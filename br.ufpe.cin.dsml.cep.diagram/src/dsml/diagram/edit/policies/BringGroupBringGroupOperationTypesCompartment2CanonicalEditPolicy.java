 ...
 * @generated
 */
public class BringGroupBringGroupOperationTypesCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getBringGroup_OperationTypes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7014SemanticChildren((View) getHost()
						.getModel());
