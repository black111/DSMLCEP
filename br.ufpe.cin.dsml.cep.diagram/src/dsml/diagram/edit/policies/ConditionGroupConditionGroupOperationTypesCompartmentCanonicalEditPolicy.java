 ...
 * @generated
 */
public class ConditionGroupConditionGroupOperationTypesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7004SemanticChildren((View) getHost()
						.getModel());
