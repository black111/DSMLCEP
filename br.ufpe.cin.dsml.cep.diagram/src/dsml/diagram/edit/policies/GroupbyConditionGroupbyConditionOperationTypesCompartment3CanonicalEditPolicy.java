 ...
 * @generated
 */
public class GroupbyConditionGroupbyConditionOperationTypesCompartment3CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7015SemanticChildren((View) getHost()
						.getModel());
