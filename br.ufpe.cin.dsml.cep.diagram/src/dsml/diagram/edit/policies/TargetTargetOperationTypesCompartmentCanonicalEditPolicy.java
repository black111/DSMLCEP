 ...
 * @generated
 */
public class TargetTargetOperationTypesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7002SemanticChildren((View) getHost()
						.getModel());
