 ...
 * @generated
 */
public class EventOutputEventOutputQueriesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getEventOutput_Queries();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getEventOutputEventOutputQueriesCompartment_7025SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getEventOutputEventOutputQueriesCompartment_7025SemanticChildren((View) getHost()
						.getModel());
