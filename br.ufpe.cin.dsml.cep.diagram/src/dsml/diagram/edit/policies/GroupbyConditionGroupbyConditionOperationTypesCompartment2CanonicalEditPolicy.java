 ...
 * @generated
 */
public class GroupbyConditionGroupbyConditionOperationTypesCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getGroupbyCondition_OperationTypes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7012SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7012SemanticChildren((View) getHost()
						.getModel());
