 ...
 * @generated
 */
public class BringGroupBringGroupOperationTypesCompartment4CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7018SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7018SemanticChildren((View) getHost()
						.getModel());
