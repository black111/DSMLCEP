 ...
 * @generated
 */
public class ConditionGroupConditionGroupOperationTypesCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getConditionGroupConditionGroupOperationTypesCompartment_7010SemanticChildren((View) getHost()
						.getModel());
