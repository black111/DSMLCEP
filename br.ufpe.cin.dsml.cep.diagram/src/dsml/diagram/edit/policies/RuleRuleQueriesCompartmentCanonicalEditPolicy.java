 ...
 * @generated
 */
public class RuleRuleQueriesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getRule_Queries();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getRuleRuleQueriesCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getRuleRuleQueriesCompartment_7001SemanticChildren((View) getHost()
						.getModel());
