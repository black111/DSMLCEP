 ...
 * @generated
 */
public class BringGroupBringGroupOperationTypesCompartment5CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7021SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getBringGroupBringGroupOperationTypesCompartment_7021SemanticChildren((View) getHost()
						.getModel());
