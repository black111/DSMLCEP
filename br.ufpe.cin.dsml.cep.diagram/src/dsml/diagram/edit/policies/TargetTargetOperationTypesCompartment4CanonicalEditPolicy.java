 ...
 * @generated
 */
public class TargetTargetOperationTypesCompartment4CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7007SemanticChildren((View) getHost()
						.getModel());
