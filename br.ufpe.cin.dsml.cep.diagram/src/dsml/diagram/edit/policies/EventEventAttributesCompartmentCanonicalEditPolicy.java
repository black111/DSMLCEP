 ...
 * @generated
 */
public class EventEventAttributesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsmlPackage.eINSTANCE.getEvent_Attributes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getEventEventAttributesCompartment_7022SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return AttributeEditPart.VISUAL_ID == DsmlVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getEventEventAttributesCompartment_7022SemanticChildren((View) getHost()
						.getModel());
