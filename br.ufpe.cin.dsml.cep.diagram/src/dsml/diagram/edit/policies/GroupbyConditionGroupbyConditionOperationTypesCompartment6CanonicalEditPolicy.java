 ...
 * @generated
 */
public class GroupbyConditionGroupbyConditionOperationTypesCompartment6CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7028SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7028SemanticChildren((View) getHost()
						.getModel());
