 ...
 * @generated
 */
public class TargetTargetOperationTypesCompartment6CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7024SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getTargetTargetOperationTypesCompartment_7024SemanticChildren((View) getHost()
						.getModel());
