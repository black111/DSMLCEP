 ...
 * @generated
 */
public class GroupbyConditionGroupbyConditionOperationTypesCompartment4CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7016SemanticChildren((View) getHost()
						.getModel());
