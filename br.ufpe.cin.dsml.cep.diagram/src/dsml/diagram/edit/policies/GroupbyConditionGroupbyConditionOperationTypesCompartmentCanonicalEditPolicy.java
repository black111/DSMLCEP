 ...
 * @generated
 */
public class GroupbyConditionGroupbyConditionOperationTypesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsmlNodeDescriptor> childDescriptors = DsmlDiagramUpdater
				.getGroupbyConditionGroupbyConditionOperationTypesCompartment_7006SemanticChildren((View) getHost()
						.getModel());
