...
import dsml.diagram.edit.commands.LinkPatternTargetCreateCommand;
import dsml.diagram.edit.commands.LinkPatternTargetReorientCommand;
import dsml.diagram.edit.commands.LinkTargetCreateCommand;
import dsml.diagram.edit.commands.LinkTargetReorientCommand;
...
import dsml.diagram.edit.parts.TargetTargetOperationTypesCompartment3EditPart;
 ...
 * @generated
 */
public class Target3ItemSemanticEditPolicy extends
		DsmlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Target3ItemSemanticEditPolicy() {
		super(DsmlElementTypes.Target_3009);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (DsmlElementTypes.LinkTarget_4004 == req.getElementType()) {
			return getGEFWrapper(new LinkTargetCreateCommand(req,
					req.getTarget(), req.getSource()));
		}
		if (DsmlElementTypes.LinkPatternTarget_4005 == req.getElementType()) {
			return getGEFWrapper(new LinkPatternTargetCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(
		...
		case LinkTargetEditPart.VISUAL_ID:
			return getGEFWrapper(new LinkTargetReorientCommand(req));
		case LinkPatternTargetEditPart.VISUAL_ID:
			return getGEFWrapper(new LinkPatternTargetReorientCommand(req));
		}
