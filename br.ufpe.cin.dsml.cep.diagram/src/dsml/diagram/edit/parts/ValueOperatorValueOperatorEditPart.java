 ...
 * @generated
 */
public class ValueOperatorValueOperatorEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ValueOperatorValueOperatorEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.ValueOperatorValueOperatorEditPart.VISUAL_ID));
		}
		return parser;
	}
