 ...
 * @generated
 */
public class TargetGroupbyTargetGroupbyEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public TargetGroupbyTargetGroupbyEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.TargetGroupbyTargetGroupbyEditPart.VISUAL_ID));
		}
		return parser;
	}
