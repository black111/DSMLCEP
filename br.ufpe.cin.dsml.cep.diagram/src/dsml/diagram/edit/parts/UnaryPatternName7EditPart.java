 ...
 * @generated
 */
public class UnaryPatternName7EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnaryPatternName7EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.UnaryPatternName7EditPart.VISUAL_ID));
		}
		return parser;
	}
