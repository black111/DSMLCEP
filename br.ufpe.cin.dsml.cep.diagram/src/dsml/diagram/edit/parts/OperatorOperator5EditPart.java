 ...
 * @generated
 */
public class OperatorOperator5EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperatorOperator5EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.OperatorOperator5EditPart.VISUAL_ID));
		}
		return parser;
	}
