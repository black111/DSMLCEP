 ...
 * @generated
 */
public class NotDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.NotDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
