 ...
 * @generated
 */
public class ArithmeticArithmeticEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				DsmlVisualIDRegistry
						.getType(dsml.diagram.edit.parts.ArithmeticArithmeticEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ArithmeticArithmeticEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ArithmeticLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ArithmeticLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ArithmeticLabelFigure() {
			this.setText("Arithmetic");
		}
