 ...
 * @generated
 */
public class TargetTargetAlias3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TargetTargetAlias3EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.TargetTargetAlias3EditPart.VISUAL_ID));
		}
		return parser;
	}
