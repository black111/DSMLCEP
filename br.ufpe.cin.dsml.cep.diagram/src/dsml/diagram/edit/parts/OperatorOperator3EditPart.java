 ...
 * @generated
 */
public class OperatorOperator3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperatorOperator3EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.OperatorOperator3EditPart.VISUAL_ID));
		}
		return parser;
	}
