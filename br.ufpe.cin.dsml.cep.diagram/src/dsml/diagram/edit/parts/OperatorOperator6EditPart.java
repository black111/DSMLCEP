 ...
 * @generated
 */
public class OperatorOperator6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperatorOperator6EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.OperatorOperator6EditPart.VISUAL_ID));
		}
		return parser;
	}
