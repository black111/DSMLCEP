 ...
 * @generated
 */
public class PatternTimerPatternTimerEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PatternTimerPatternTimerEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.PatternTimerPatternTimerEditPart.VISUAL_ID));
		}
		return parser;
	}
