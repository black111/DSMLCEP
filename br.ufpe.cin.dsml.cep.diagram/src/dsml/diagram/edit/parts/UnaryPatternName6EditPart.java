 ...
 * @generated
 */
public class UnaryPatternName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnaryPatternName6EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.UnaryPatternName6EditPart.VISUAL_ID));
		}
		return parser;
	}
