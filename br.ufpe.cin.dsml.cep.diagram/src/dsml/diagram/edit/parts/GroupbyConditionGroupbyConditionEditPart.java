 ...
 * @generated
 */
public class GroupbyConditionGroupbyConditionEditPart extends
	 ...
	 * @generated
	 */
	public GroupbyConditionGroupbyConditionEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.GroupbyConditionGroupbyConditionEditPart.VISUAL_ID));
		}
		return parser;
	}
