...
import dsml.diagram.edit.policies.ValueOperator5ItemSemanticEditPolicy;
import dsml.diagram.part.DsmlVisualIDRegistry;

/**
 * @generated
 */
public class ValueOperator5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueOperator5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueOperator5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueOperatorValueOperator5EditPart) {
			((ValueOperatorValueOperator5EditPart) childEditPart)
