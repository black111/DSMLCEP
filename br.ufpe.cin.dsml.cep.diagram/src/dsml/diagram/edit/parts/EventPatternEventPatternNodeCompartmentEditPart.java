...
public class EventPatternEventPatternNodeCompartmentEditPart extends
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DsmlElementTypes.Target_3057) {
				return this;
			}
			if (type == DsmlElementTypes.Not_3058) {
				return this;
			}
			if (type == DsmlElementTypes.UnaryPattern_3059) {
				return this;
			}
			if (type == DsmlElementTypes.PatternTimer_3060) {
				return this;
			}
			if (type == DsmlElementTypes.RepeatPattern_3061) {
				return this;
			}
