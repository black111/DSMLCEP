 ...
 * @generated
 */
public class TargetTargetAlias6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TargetTargetAlias6EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.TargetTargetAlias6EditPart.VISUAL_ID));
		}
		return parser;
	}
