...
import dsml.diagram.edit.policies.DsmlTextSelectionEditPolicy;
 ...
 * @generated
 */
public class LinkPatternTargetComparisonTargetEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				DsmlVisualIDRegistry
						.getType(dsml.diagram.edit.parts.LinkPatternTargetComparisonTargetEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public LinkPatternTargetComparisonTargetEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DsmlTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null,
					DsmlEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new LinkPatternTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LinkPatternTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LinkPatternTargetLabelFigure() {
			this.setText("LinkPatternTarget");
		}
