 ...
 * @generated
 */
public class NotDescription4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotDescription4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DsmlParserProvider
					.getParser(
							DsmlElementTypes.Not_3029,
							getParserElement(),
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.NotDescription4EditPart.VISUAL_ID));
		}
		return parser;
	}
