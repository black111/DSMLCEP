...
import dsml.diagram.edit.policies.ValueOperator3ItemSemanticEditPolicy;
import dsml.diagram.part.DsmlVisualIDRegistry;

/**
 * @generated
 */
public class ValueOperator3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueOperator3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueOperator3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueOperatorValueOperator3EditPart) {
			((ValueOperatorValueOperator3EditPart) childEditPart)
