...
import dsml.diagram.edit.policies.ConditionGroup3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConditionGroup3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ConditionGroup3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConditionGroup3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConditionGroupConditionGroup3EditPart) {
			((ConditionGroupConditionGroup3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConditionGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ConditionGroupConditionGroupOperationTypesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			pane.remove(((ConditionGroupConditionGroupOperationTypesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ConditionGroupConditionGroupOperationTypesCompartment3EditPart) {
