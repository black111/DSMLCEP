 ...
 * @generated
 */
public class TargetTargetAlias7EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TargetTargetAlias7EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.TargetTargetAlias7EditPart.VISUAL_ID));
		}
		return parser;
	}
