 ...
 * @generated
 */
public class NotDescription7EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotDescription7EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DsmlParserProvider
					.getParser(
							DsmlElementTypes.Not_3063,
							getParserElement(),
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.NotDescription7EditPart.VISUAL_ID));
		}
		return parser;
	}
