 ...
 * @generated
 */
public class EventOutputOutputNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EventOutputOutputNameEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.EventOutputOutputNameEditPart.VISUAL_ID));
		}
		return parser;
	}
