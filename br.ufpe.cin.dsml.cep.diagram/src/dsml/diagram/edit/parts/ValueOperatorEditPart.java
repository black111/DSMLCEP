...
import dsml.diagram.edit.policies.ValueOperatorItemSemanticEditPolicy;
import dsml.diagram.part.DsmlVisualIDRegistry;

/**
 * @generated
 */
public class ValueOperatorEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueOperatorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueOperatorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueOperatorValueOperatorEditPart) {
			((ValueOperatorValueOperatorEditPart) childEditPart)
