...
import dsml.diagram.edit.policies.GroupbyCondition3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupbyCondition3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GroupbyCondition3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupbyCondition3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupbyConditionGroupbyCondition3EditPart) {
			((GroupbyConditionGroupbyCondition3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureGroupbyConditionLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupbyConditionGroupbyConditionOperationTypesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			pane.remove(((GroupbyConditionGroupbyConditionOperationTypesCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment3EditPart) {
