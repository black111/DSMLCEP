...
import dsml.diagram.edit.policies.WindowGraphicalNodeEditPolicy;
import dsml.diagram.edit.policies.WindowItemSemanticEditPolicy;
...
public class WindowEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new WindowGraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WindowWindowEditPart) {
			((WindowWindowEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsmlVisualIDRegistry
				.getType(WindowWindowEditPart.VISUAL_ID));
	}
