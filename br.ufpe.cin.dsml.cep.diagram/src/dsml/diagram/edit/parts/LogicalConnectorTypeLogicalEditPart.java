 ...
 * @generated
 */
public class LogicalConnectorTypeLogicalEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				DsmlVisualIDRegistry
						.getType(dsml.diagram.edit.parts.LogicalConnectorTypeLogicalEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public LogicalConnectorTypeLogicalEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new LogicalConnectorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LogicalConnectorLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LogicalConnectorLabelFigure() {
			this.setText("LogicalConnector");
		}
