 ...
 * @generated
 */
public class AggregationTypeAggregationEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AggregationTypeAggregationEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.AggregationTypeAggregationEditPart.VISUAL_ID));
		}
		return parser;
	}
