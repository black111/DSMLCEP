 ...
 * @generated
 */
public class WindowWindowEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WindowWindowEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.WindowWindowEditPart.VISUAL_ID));
		}
		return parser;
	}
