 ...
 * @generated
 */
public class TargetTargetAlias5EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TargetTargetAlias5EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.TargetTargetAlias5EditPart.VISUAL_ID));
		}
		return parser;
	}
