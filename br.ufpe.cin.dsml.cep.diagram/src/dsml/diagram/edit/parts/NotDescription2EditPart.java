 ...
 * @generated
 */
public class NotDescription2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotDescription2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DsmlParserProvider
					.getParser(
							DsmlElementTypes.Not_3016,
							getParserElement(),
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.NotDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
