 ...
 * @generated
 */
public class ConditionGroupConditionGroup5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ConditionGroupConditionGroup5EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.ConditionGroupConditionGroup5EditPart.VISUAL_ID));
		}
		return parser;
	}
