...
import dsml.diagram.edit.policies.ConditionGroup2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConditionGroup2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ConditionGroup2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConditionGroup2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConditionGroupConditionGroup2EditPart) {
			((ConditionGroupConditionGroup2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConditionGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ConditionGroupConditionGroupOperationTypesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			pane.remove(((ConditionGroupConditionGroupOperationTypesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ConditionGroupConditionGroupOperationTypesCompartment2EditPart) {
