 ...
 * @generated
 */
public class EventPatternEventPatternEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EventPatternEventPatternEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.EventPatternEventPatternEditPart.VISUAL_ID));
		}
		return parser;
	}
