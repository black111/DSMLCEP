 ...
 * @generated
 */
public class UnaryPatternName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnaryPatternName2EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.UnaryPatternName2EditPart.VISUAL_ID));
		}
		return parser;
	}
