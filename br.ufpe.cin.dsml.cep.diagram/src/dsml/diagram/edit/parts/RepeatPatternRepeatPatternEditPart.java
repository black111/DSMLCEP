 ...
 * @generated
 */
public class RepeatPatternRepeatPatternEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RepeatPatternRepeatPatternEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.RepeatPatternRepeatPatternEditPart.VISUAL_ID));
		}
		return parser;
	}
