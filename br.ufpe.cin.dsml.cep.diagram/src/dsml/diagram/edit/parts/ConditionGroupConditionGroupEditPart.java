 ...
 * @generated
 */
public class ConditionGroupConditionGroupEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ConditionGroupConditionGroupEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.ConditionGroupConditionGroupEditPart.VISUAL_ID));
		}
		return parser;
	}
