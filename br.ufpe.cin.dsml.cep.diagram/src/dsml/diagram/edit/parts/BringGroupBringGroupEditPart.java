 ...
 * @generated
 */
public class BringGroupBringGroupEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BringGroupBringGroupEditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.BringGroupBringGroupEditPart.VISUAL_ID));
		}
		return parser;
	}
