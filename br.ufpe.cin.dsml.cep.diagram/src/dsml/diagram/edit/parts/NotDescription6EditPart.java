 ...
 * @generated
 */
public class NotDescription6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotDescription6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DsmlParserProvider
					.getParser(
							DsmlElementTypes.Not_3058,
							getParserElement(),
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.NotDescription6EditPart.VISUAL_ID));
		}
		return parser;
	}
