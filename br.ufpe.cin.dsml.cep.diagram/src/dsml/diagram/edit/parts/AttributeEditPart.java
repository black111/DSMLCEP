...
import dsml.diagram.edit.policies.AttributeItemSemanticEditPolicy;
...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AttributeNameTypeEditPart) {
			((AttributeNameTypeEditPart) childEditPart)
