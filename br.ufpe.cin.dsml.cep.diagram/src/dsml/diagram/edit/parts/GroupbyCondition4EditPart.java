...
import dsml.diagram.edit.policies.GroupbyCondition4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupbyCondition4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GroupbyCondition4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupbyCondition4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupbyConditionGroupbyCondition4EditPart) {
			((GroupbyConditionGroupbyCondition4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureGroupbyConditionLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupbyConditionGroupbyConditionOperationTypesCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			pane.remove(((GroupbyConditionGroupbyConditionOperationTypesCompartment4EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment4EditPart) {
