 ...
 * @generated
 */
public class OperatorOperator4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperatorOperator4EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.OperatorOperator4EditPart.VISUAL_ID));
		}
		return parser;
	}
