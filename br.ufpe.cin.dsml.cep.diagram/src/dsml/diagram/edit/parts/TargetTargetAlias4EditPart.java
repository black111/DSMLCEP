 ...
 * @generated
 */
public class TargetTargetAlias4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TargetTargetAlias4EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.TargetTargetAlias4EditPart.VISUAL_ID));
		}
		return parser;
	}
