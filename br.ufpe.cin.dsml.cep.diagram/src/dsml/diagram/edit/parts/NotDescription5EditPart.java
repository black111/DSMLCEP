 ...
 * @generated
 */
public class NotDescription5EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotDescription5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DsmlParserProvider
					.getParser(
							DsmlElementTypes.Not_3046,
							getParserElement(),
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.NotDescription5EditPart.VISUAL_ID));
		}
		return parser;
	}
