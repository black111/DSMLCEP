...
import dsml.diagram.edit.policies.EventGraphicalNodeEditPolicy;
import dsml.diagram.edit.policies.EventItemSemanticEditPolicy;
...
public class EventEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new EventGraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventEventNameEditPart) {
			((EventEventNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEventLabelFigure());
			return true;
		}
		if (childEditPart instanceof EventEventAttributesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getEventAttributesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EventEventAttributesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventEventAttributesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getEventAttributesCompartmentFigure();
			pane.remove(((EventEventAttributesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EventEventAttributesCompartmentEditPart) {
			return getPrimaryShape().getEventAttributesCompartmentFigure();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DsmlVisualIDRegistry
				.getType(EventEventNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DsmlElementTypes.Attribute_3056) {
				return getChildBySemanticHint(DsmlVisualIDRegistry
	...
	public class EventFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fEventAttributesCompartmentFigure;
		...
		private void createContents() {
			...
			fEventAttributesCompartmentFigure = new RectangleFigure();

			fEventAttributesCompartmentFigure.setOutline(false);

			this.add(fEventAttributesCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getEventAttributesCompartmentFigure() {
			return fEventAttributesCompartmentFigure;
		}
