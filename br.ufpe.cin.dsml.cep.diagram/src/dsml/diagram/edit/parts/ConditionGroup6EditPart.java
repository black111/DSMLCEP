...
import dsml.diagram.edit.policies.ConditionGroup6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConditionGroup6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ConditionGroup6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConditionGroup6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConditionGroupConditionGroup6EditPart) {
			((ConditionGroupConditionGroup6EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConditionGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ConditionGroupConditionGroupOperationTypesCompartment6EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			pane.remove(((ConditionGroupConditionGroupOperationTypesCompartment6EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ConditionGroupConditionGroupOperationTypesCompartment6EditPart) {
