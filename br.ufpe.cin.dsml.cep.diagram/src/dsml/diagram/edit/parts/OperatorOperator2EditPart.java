 ...
 * @generated
 */
public class OperatorOperator2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperatorOperator2EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.OperatorOperator2EditPart.VISUAL_ID));
		}
		return parser;
	}
