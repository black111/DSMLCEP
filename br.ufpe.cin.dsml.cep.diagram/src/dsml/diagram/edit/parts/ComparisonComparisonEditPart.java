 ...
 * @generated
 */
public class ComparisonComparisonEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				DsmlVisualIDRegistry
						.getType(dsml.diagram.edit.parts.ComparisonComparisonEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ComparisonComparisonEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ComparisonLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ComparisonLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ComparisonLabelFigure() {
			this.setText("Comparison");
		}
