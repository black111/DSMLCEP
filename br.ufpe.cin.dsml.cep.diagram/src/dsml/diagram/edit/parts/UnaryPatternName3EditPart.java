 ...
 * @generated
 */
public class UnaryPatternName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnaryPatternName3EditPart(View view) {
		super(view);
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.UnaryPatternName3EditPart.VISUAL_ID));
		}
		return parser;
	}
