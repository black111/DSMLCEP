 ...
 * @generated
 */
public class ConditionGroupConditionGroup4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ConditionGroupConditionGroup4EditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return DsmlElementTypes.getImage(parserElement.eClass());
	}
			...
			parser = DsmlParserProvider
					.getParser(
							...
							DsmlVisualIDRegistry
									.getType(dsml.diagram.edit.parts.ConditionGroupConditionGroup4EditPart.VISUAL_ID));
		}
		return parser;
	}
