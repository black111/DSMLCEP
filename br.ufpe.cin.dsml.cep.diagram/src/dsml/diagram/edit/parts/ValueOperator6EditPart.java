...
import dsml.diagram.edit.policies.ValueOperator6ItemSemanticEditPolicy;
import dsml.diagram.part.DsmlVisualIDRegistry;

/**
 * @generated
 */
public class ValueOperator6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueOperator6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueOperator6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueOperatorValueOperator6EditPart) {
			((ValueOperatorValueOperator6EditPart) childEditPart)
