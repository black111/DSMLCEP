...
import dsml.diagram.edit.policies.GroupbyCondition2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupbyCondition2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GroupbyCondition2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupbyCondition2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupbyConditionGroupbyCondition2EditPart) {
			((GroupbyConditionGroupbyCondition2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureGroupbyConditionLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupbyConditionGroupbyConditionOperationTypesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			pane.remove(((GroupbyConditionGroupbyConditionOperationTypesCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment2EditPart) {
