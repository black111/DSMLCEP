...
import dsml.diagram.edit.policies.GroupbyCondition6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupbyCondition6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public GroupbyCondition6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupbyCondition6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupbyConditionGroupbyCondition6EditPart) {
			((GroupbyConditionGroupbyCondition6EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureGroupbyConditionLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupbyConditionGroupbyConditionOperationTypesCompartment6EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupbyConditionOperationTypesCompartmentFigure();
			pane.remove(((GroupbyConditionGroupbyConditionOperationTypesCompartment6EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupbyConditionGroupbyConditionOperationTypesCompartment6EditPart) {
