...
import dsml.diagram.edit.policies.ValueOperator4ItemSemanticEditPolicy;
import dsml.diagram.part.DsmlVisualIDRegistry;

/**
 * @generated
 */
public class ValueOperator4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueOperator4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueOperator4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueOperatorValueOperator4EditPart) {
			((ValueOperatorValueOperator4EditPart) childEditPart)
