...
import dsml.diagram.edit.policies.ConditionGroupItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConditionGroupEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ConditionGroupEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConditionGroupItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConditionGroupConditionGroupEditPart) {
			((ConditionGroupConditionGroupEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConditionGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ConditionGroupConditionGroupOperationTypesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConditionGroupConditionGroupOperationTypesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getConditionGroupOperationTypesCompartmentFigure();
			pane.remove(((ConditionGroupConditionGroupOperationTypesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ConditionGroupConditionGroupOperationTypesCompartmentEditPart) {
