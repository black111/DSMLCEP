 ...
 * @generated
 */
public class DsmlModelingAssistantProviderOfGroupbyConditionEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((GroupbyConditionEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			GroupbyConditionEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(GroupbyConditionEditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			GroupbyConditionEditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((GroupbyConditionEditPart) sourceEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			GroupbyConditionEditPart source, IElementType relationshipType) {
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((GroupbyConditionEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			GroupbyConditionEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(3);
		types.add(DsmlElementTypes.Comparison_4001);
		types.add(DsmlElementTypes.Arithmetic_4002);
		types.add(DsmlElementTypes.LogicalConnector_4003);
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((GroupbyConditionEditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			GroupbyConditionEditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == DsmlElementTypes.Comparison_4001) {
			types.add(DsmlElementTypes.Target_3001);
			types.add(DsmlElementTypes.Target_3002);
