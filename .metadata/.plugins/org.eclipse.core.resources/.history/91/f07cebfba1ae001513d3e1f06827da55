 ...
 * @generated
 */
public class DsmlDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public DsmlDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof DsmlDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((DsmlDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new DsmlDomainNavigatorItem((EObject) objects[i],
