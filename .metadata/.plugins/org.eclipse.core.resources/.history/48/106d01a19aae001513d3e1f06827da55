...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Arithmetic</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see dsml.DsmlPackage#getTypeArithmetic()
 * @model
 * @generated
 */
public enum TypeArithmetic implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	SUBTRACTION(4, "SUBTRACTION", "SUBTRACTION");
	...
	/**
	 * An array of all the '<em><b>Type Arithmetic</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TypeArithmetic[] VALUES_ARRAY =
		new TypeArithmetic[] {
			ADDITION,
			DIVISION,
			MODULUS,
	...
	/**
	 * A public read-only list of all the '<em><b>Type Arithmetic</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TypeArithmetic> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Type Arithmetic</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeArithmetic get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeArithmetic result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Arithmetic</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeArithmetic getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeArithmetic result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Arithmetic</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeArithmetic get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TypeArithmetic(int value, String name, String literal) {
		this.value = value;
		this.name = name;
