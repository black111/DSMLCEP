...
import dsml.diagram.part.DsmlDiagramEditorUtil;

/**
 * @generated
 */
public class DsmlMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = DsmlDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DsmlDiagramEditorUtil.selectElementsInDiagram(editor,
